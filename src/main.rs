...
use server::game_management::{block_players_in_bound, player_mov, resize_boundaries, spawn_boundaries, spawn_camera, spawn_player,update_name_tag_position};
...
fn main() {
    ...
    App::new()
        ...
        // .add_systems(Startup, update_name_tag_position)
        .run();
